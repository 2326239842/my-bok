...
![封面](/images/slide_01.png)

**数据仪表盘** — 12个核心指标卡片：

![仪表盘](/images/slide_13.png)

**全球经济增长预测** — 数据卡片+表格+洞察框：

![全球概览](/images/slide_03.png)

**AI投资爆发** — 柱状图+科技巨头Capex数据：

![AI投资](/images/slide_05.png)

**风险矩阵** — 仪表盘卡片+三情景分析：

![风险矩阵](/images/slide_10.png)

**结尾页** — 深蓝渐变+未来城市图片+缩放动画：

![结尾](/images/slide_16.png)
